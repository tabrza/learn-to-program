...
bottles = 100
while bottles >0
  puts englishNumber(bottles) + " of beer on the wall," + englishNumber(bottles) + " of beer"
  bottles -= 1
  puts "Drink one more, pass it around, " + englishNumber(bottles) + " of beer on the wall."
end


puts " Oh no, there's nothing left, better restock for another round of bottles of beer on the wall!"
